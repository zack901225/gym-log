...
async function chooseExercise(id) {
  ...
  if (await mutate(next => {
    ...
    else { Object.assign(e, { duration: 0, speed: 0, completed: false }); if (x.type === 'warmup') Object.assign(e, { reps: 0, sets: 0, incline: 0 }); else Object.assign(e, { incline: 0, distance: null }); }
